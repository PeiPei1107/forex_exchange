...
$lang['required'] = "%s 是必填的欄位";
$lang['isset'] = "%s 欄位必須有值";
$lang['valid_email'] = "%s 欄位必須為正確的電子郵件";
$lang['valid_emails'] = "%s 欄位必須為正確的電子郵件";
$lang['valid_url'] = "%s 欄位必須為正確的URL";
$lang['valid_url_pic'] = "%s 欄位必須為結尾為JPG、GIF、PNG檔名的URL";
...
$lang['greater_than'] = "%s 欄位數值必須大於 %s";/* End of file form_validation_lang.php */
